...
class CalendarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let requestURL = NSURL(string: "http://www.bcsdny.org/calendar_events.cfm?&cat=0&location=1&themonth=4&theyear=2017&buildit=0.316616187762&AddSportingEvents=0&printPage=1")
